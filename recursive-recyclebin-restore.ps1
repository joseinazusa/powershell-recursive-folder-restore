...
$siteUrl = "https://contoso.sharepoint.com/teams/team1"
# The Folder to Restore - Full Path
$directoryToRestore = 'root/tothefolderyouwanttorestore/'
...
$restoreSet = Get-PnPRecycleBinItem -FirstStage -RowLimit $maxRows | Where-Object {$_."Dirname" -Like $directoryToRestore + '/*' -or $_."Dirname" -Eq $directoryToRestore} 
